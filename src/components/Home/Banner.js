    ...
    <div style={bannerStyles}>
      <div className="container min-h-screen  flex flex-col justify-center">
        <div style={{ maxWidth: "800px" }}>
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl text-gray-50 pb-3 font-bold">
          ...
          <button className="bg-gray-900 text-lg px-6 py-2 text-gray-50 hover:text-gray-900 hover:bg-gray-50 mt-3 rounded-md transition-all duration-150 ease-linear">
            Explore Now
          </button>
        </div>
      </div>
